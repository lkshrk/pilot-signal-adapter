...
// Client streams received frames from signal-cli-rest-api in json-rpc mode.
type Client struct {
	receiveURL  string
...
func WithOnReconnect(fn func(attempt int, connectedFor time.Duration, cause error)) Option {
...
func New(baseURL, account string, opts ...Option) (*Client, error) {
...
func (c *Client) Run(ctx context.Context, onFrame func(Frame)) error {
...
func (c *Client) stream(ctx context.Context, onFrame func(Frame)) (time.Duration, bool, error) {
